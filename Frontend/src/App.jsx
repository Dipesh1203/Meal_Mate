      ...
      <Routes>
        ...
        {entityType === 'PROVIDER' && (
          <Route element={<PrivateRoute allowedEntities={['PROVIDER']} />}>
            ...
            <Route path="provider/tipsandsuggestions" element={<TipsAndSuggestions />} />
            <Route path="provider/food_management" element={<Food_Management />} />
            <Route path="provider/" element={<Test />} />
            <Route path="provider/donation-center" element={<DonationCenter />} />
          </Route>
        )}
